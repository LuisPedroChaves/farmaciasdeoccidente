...
export class HistoryComponent implements OnInit, AfterContentInit {
  ...
  ngAfterContentInit() {
    const filter = { month: this.month, year: this.year, _cellar: this.currentCellar._id, type: 'TRASLADO', origin: this.currentOrigin};
  ...
  applyFilter(filterValue?: string) {
    ...
    if (filterValue) {
      ...
      const filters = { month: this.month, year: this.year, _cellar: this.currentCellar._id, type: 'TRASLADO', origin: this.currentOrigin };
