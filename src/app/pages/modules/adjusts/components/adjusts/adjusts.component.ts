...
import { NewAdjustComponent } from '../../../purchases/components/new-adjust/new-adjust.component';

@Component({
  selector: 'app-adjusts',
  templateUrl: './adjusts.component.html',
  styleUrls: ['./adjusts.component.scss']
})
export class AdjustsComponent implements OnInit {
  ...
  columns = ['image', 'noBill', '_provider', 'date', 'requisition', 'options'];
  ...
  ngOnInit(): void {
    this.newAdjust('HOLA MUNDO');
  }

  newAdjust(details) {
    const dialogRef = this.dialog.open(NewAdjustComponent, {
